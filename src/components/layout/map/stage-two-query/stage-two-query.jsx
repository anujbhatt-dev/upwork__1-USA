     ...
     onSubmitHandler=(e)=>{
      ...
      let client={...this.state.client}
       ...
       fireDb.child("client/"+key).on('value',res=>{
          ...
          fireDb.child("client").child(key).set(this.state.client);
   ...
   render(){
     ...
     return (
       ...
       <form onSubmit={this.onSubmitHandler} className="form query__item query__fixer query__believer">
         ...
         <input value={this.state.client.country} name="country" placeholder="country" required onChange={(e)=>this.onChangeHandler(e,"believer")} className="form__input" type="text"/>
       ...
       <form onSubmit={this.onSubmitHandler} className="form query__item query__fixer query__non-believer">
         ...
         <input value={this.state.client.country} name="country" placeholder="Country" required onChange={(e)=>this.onChangeHandler(e,"notABeliever")} className="form__input" type="text"/>
