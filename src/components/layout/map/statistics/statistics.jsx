...
import axios from 'axios';
 ...
 class Statistics extends Component{
   ...
   componentDidMount(){
     ...
     axios.get("/v1/client/country/count").then(res=>{
                     ...
                     :`-webkit-linear-gradient(top, #81b214 ${this.state.bPercent}%, #206a5d ${(this.state.bPercent+this.state.nbPercent)}%, #bfdcae 100%)`
 ...
 componentDidUpdate(prevProps, prevState){
   ...
   let gradient = isNaN(this.state.bPercent)
   ?`-webkit-linear-gradient(top, black 0%, black 100%)`
   :`-webkit-linear-gradient(top, #81b214 ${(this.state.bPercent)}%, #206a5d ${(this.state.bPercent)}%, #206a5d ${(this.state.bPercent+this.state.nbPercent)}%,#bfdcae ${(this.state.bPercent+this.state.nbPercent)}%, #bfdcae 100%)`
   console.log(gradient);
   element.style.backgroundImage = gradient
